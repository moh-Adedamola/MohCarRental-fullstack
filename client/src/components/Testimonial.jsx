...
const Testimonial = () => {
 ...
 const testimonials = [
        ...
        { name: "oliva jackson", 
          ...
          testimonial: "CarRental made m trip so much easier. The car was delivered right to my door, and the customer service was fantastic."
        },
        { name: "Lara smith", 
    ...
    return (
        <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
            ...
            <Title title="What Our Costumers Say" subTitle="Discover why our discerning travelers chose StayVenture for their 
            luxury accomodations around the world." />
