...
export const AppProvider = ({ children })=>{
    ...
    const [returnDate, setReturnDate] = useState('') // Fixed typo: setReurnDate -> setReturnDate
    ...
    const fetchUser = async ()=>{
        try {
            const {data} = await axios.get('/api/user/data') // Added destructuring
            if (data.success) {
                setUser(data.user)
    ...
    const value = {
        ...
        returnDate, setReturnDate // Fixed variable name
    }
