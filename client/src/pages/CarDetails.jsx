    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
            ...
            onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
                ...
                <p className='flex items-center justify-between text-2xl text-gray-800 font-semibold'>{currency}{car.pricePerDay}<span className='text-base text-gray-400 font-nomal'>per day</span></p>
                    ...
                    <button className='w-full bg-primary hover:bg-primary-dull transition-all py-3 font-medium
                     ...
                     <p className='text-center text-sm'>No Credit Card Required To Make Reservation</p>
            </motion.form>
        </div>
